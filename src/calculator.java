...
public class calculator extends Frame implements ActionListener {
    Button btn0,btn1,btn2,btn3,btn4,btn5,btn6,btn7,btn8,btn9,minus,plus,multi,div,equals,clear;
    TextField display;
    calculator(){

        display = new TextField("0");
        display.setBounds(50,50,380,50);
